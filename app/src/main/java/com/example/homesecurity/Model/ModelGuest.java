...
public class ModelGuest {
    ...
    public ModelGuest(String keyUID, String name, String phone, String work, String flat, String dateOutCitizen, String timeOutCitizen, Boolean exitCitizen, Boolean allowed, String dateInGuard, String timeInGuard, Boolean exitGuard, String timeOutGuard, String dateOutGuard, String guardIn, String guardOut) {
        KeyUID = keyUID;
        Name = name;
        Phone = phone;
        Work = work;
